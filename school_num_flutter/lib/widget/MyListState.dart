...
import 'package:school_num_flutter/common/Config.dart';
import 'package:school_num_flutter/widget/MyPullLoadWidget.dart';

abstract class MyListState<T extends StatefulWidget> extends State<T> with AutomaticKeepAliveClientMixin {
  bool isShow = false;
